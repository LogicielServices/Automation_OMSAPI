...
public class Update {
										    ...
										    String UpdateFlag)
	{
		try
		{
			...
			LoggingManager.logger.info("API-Updated_EquityOrder_Order_ID : ["+Global.getOrderID+"]");
			LoggingManager.logger.info("API-Updated_EquityOrder_ValidationFlag : ["+Global.ValidationFlag+"]");
