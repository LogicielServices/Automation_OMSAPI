...
{	
	 ...
	 Response get_execution_response=
 			...
 			getResponseArray=apiRespVersion(endpoint_version);
 			int ResponseArraySize = jsonresponse.getInt(getResponseArray+".size()");
 			AvgPxLoop : for(int position = ResponseArraySize-1; position >=0; position--) 
			{
										...
										String CaseType)	
{
		 ...
		 ArrayList<String> getBuyOrderid = new ArrayList<String>();
		 ArrayList<String> getSellOrderid = new ArrayList<String>();
		...
		// Map<String,String> getBuyOrderid = new HashMap<String,String>();
		...
		// Map<String,String> getSellOrderid = new HashMap<String,String>();
