...
public class OptionOrder_Positions {
	...
	public void afterMethod(ITestResult result) 
	{
	 ...
	 @Test (dataProvider="SubscribeOption_Positions", dataProviderClass=ExcelDataProvider.class , groups={"SubscribeOption_Positions"}, dependsOnGroups={"UserLoginAuthentications"})//UserLoginAuthentications
	 public void Verify_Subscribe_Option_Positions(String OptionOrder_Position_TestCase,
													...
													String Validate_Position_account_Value )
	 {
	 	try
		{
			 ...
			 LoggingManager.logger.info("TestCase : "+OptionOrder_Position_TestCase);
			 LoggingManager.logger.info("====================================================================");
