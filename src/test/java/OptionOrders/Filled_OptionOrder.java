...
public class Filled_OptionOrder {
	...
	public void Verify_BUY_Order_Creation_Filled(String OptionOrder_Creation_TestCase,
		...
		try {
			...
			if (Endpoint_Version.equalsIgnoreCase("V1")) {
				Assert.assertEquals(response.getBody().asString(), OptionOrder_Creation_Response, "Order_Creation_Filled");
			} else {
				Assert.assertEquals(response.jsonPath().get("message"), OptionOrder_Creation_Response, "Order_Creation_Filled");
			}
		} catch (Exception e) {
	...
	public void Verify_SELL_Order_Creation_Filled(String OptionOrder_Creation_TestCase,
		...
		try {
			...
			if (Endpoint_Version.equalsIgnoreCase("V1")) {
				Assert.assertEquals(buy_response.getBody().asString(), OptionOrder_Creation_Response, "Verify_BUY_Order_Creation_Filled_Status");
			} else {
				Assert.assertEquals(buy_response.jsonPath().get("message"), OptionOrder_Creation_Response, "Verify_BUY_Order_Creation_Filled_Status");
			}
...
//====================================================SELL Order=============================================================================			
			...
			if (Endpoint_Version.equalsIgnoreCase("V1")) {
				Assert.assertEquals(sell_response.getBody().asString(), OptionOrder_Creation_Response, "Verify_SELL_OptionOrder_Creation_Response");
			} else {
				Assert.assertEquals(sell_response.jsonPath().get("message"), OptionOrder_Creation_Response, "Verify_SELL_OptionOrder_Creation_Response");
			}
		}
		catch (Exception e)
		{
