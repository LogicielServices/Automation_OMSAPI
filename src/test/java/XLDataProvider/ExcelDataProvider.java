...
public class ExcelDataProvider {
    ...
    String accountsDataFileDirectory = "/src/test/java/Account/Data/Account.xlsx";
    ...
    @DataProvider(name = "CreateAccountsData")
    public Object[][] CreateAccountsData() throws IOException {
        return GetExcelData(accountsDataFileDirectory, "CreateAccount");
    }

    @DataProvider(name = "GetAccountsData")
    public Object[][] GetAccountsData() throws IOException {
        return GetExcelData(accountsDataFileDirectory, "GetAccount");
    }

    @DataProvider(name = "DeleteAccountsData")
    public Object[][] DeleteAccountsData() throws IOException {
        return GetExcelData(accountsDataFileDirectory, "DeleteAccount");
    }
}
