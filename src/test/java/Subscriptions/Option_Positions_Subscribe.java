...
public class Option_Positions_Subscribe {
	...
	public void afterMethod(ITestResult result) 
	{
	 ...
	 public void Verify_Subscribe_BUY_Option_Positions(	String Option_Position_TestCases,
														...
														String Flat_Order_Creation_BasePath,
														String Flat_Order_Side,
														String Flat_Order_OrdType,
														String Flat_Order_TimeInForce,
														String Flat_Order_Destination,
														String Flat_Order_Price,
														String Flat_Order_StopPx,
														String Flat_Order_PutOrCall,
														String Flat_Order_StrikePrice,
														String Flat_Order_CoveredOrUncovered,
														String Flat_Order_CustomerOrFirm,
														String Flat_Order_Cmta,
														String Flat_Order_OpenClose,
														String Flat_Order_ExpiryDate,
														String Flat_Order_Creation_StatusCode,
	 ...
	 public void Verify_SubscribeSELLOption_Positionss(	String Order_Position_TestCases,
														String Endpoint_Version,
														String Subscribe_Option_Positions_BasePath,
														String Content_Type,
														String Subscribe_Option_Positions_StatusCode,
